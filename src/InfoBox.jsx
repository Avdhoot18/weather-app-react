...
export default function InfoBox({ info}){
    const INIT_URL=
    "https://plus.unsplash.com/premium_photo-1678066986924-120fdbdf3439?w=1000&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MXx8ZHVzdHklMjB3ZWF0aGVyfGVufDB8fDB8fHww";
    ...
    const RAIN_URL ="https://images.unsplash.com/photo-1613739118925-cde1e8f5d65b?q=80&w=387&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D";
    ...
    <div className="InfoBox">
      ...
      <CardContent>
        ...
        <Typography variant="body2" color="text.secondary" component={"span"} >
          ...
          <p>Manx Temp = {info.tempMax}&deg;C</p>
          <p>the weather feels like {info.feelslike}{info.weather}</p>
        </Typography>
      </CardContent>
